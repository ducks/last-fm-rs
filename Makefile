...
help:
	@echo "last-fm-rs Makefile"
	@echo ""
	@echo "Usage:"
	@echo "  make version-bump 0.1.0            - Bump version in Cargo.toml and commit"
	@echo "  make release 0.1.0                 - Bump version and push tag to trigger release"
	@echo "  make build                         - Build release binary"
	@echo "  make test                          - Run tests"
	@echo "  make clean                         - Clean build artifacts"
	@echo ""
	@echo "Examples:"
	@echo "  make version-bump 0.1.0            - Creates branch and bumps version"
	@echo "  make release 0.1.0                 - Full release (merge, tag, push)"
	@echo ""
	@echo "Note: VERSION prefix is optional:"
	@echo "  make release 0.2.0                 - Creates tag v0.2.0"
	@echo "  make release v0.2.0                - Creates tag v0.2.0 (same)"

# Bump version in Cargo.toml and commit on a branch
version-bump:
ifeq ($(VERSION),)
	$(error No version specified. Use: make version-bump 0.1.0)
endif
